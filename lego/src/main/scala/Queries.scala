...
object Queries {
  ...
  def Q5(numRuns: Int) {
    ...
    runQuery({
      ...
      val jo2 = new HashJoinOp(jo1, scanSupplier)((x, y) => x.N_NATIONKEY[Int] == y.S_NATIONKEY)(x => x.N_NATIONKEY[Int])(x => x.S_NATIONKEY)
      /* ----- ORIGINAL PLAN ------
	  val jo3 = new HashJoinOp(jo2, scanCustomer)((x, y) => x.N_NATIONKEY[Int] == y.C_NATIONKEY)(x => x.S_NATIONKEY[Int])(x => x.C_NATIONKEY)
      val jo4 = new HashJoinOp(jo3, scanOrders)((x, y) => x.C_CUSTKEY[Int] == y.O_CUSTKEY)(x => x.C_CUSTKEY[Int])(x => x.O_CUSTKEY)
      val jo5 = new SelectOp(new HashJoinOp(jo4, scanLineitem)((x, y) => x.O_ORDERKEY[Int] == y.L_ORDERKEY)(x => x.O_ORDERKEY[Int])(x => x.L_ORDERKEY))(x => x.S_SUPPKEY[Int] == x.L_SUPPKEY[Int])
		----- NEW PLAN ------
	  */
      val jo3 = new HashJoinOp(scanOrders, scanLineitem)((x, y) => x.O_ORDERKEY == y.L_ORDERKEY)(x => x.O_ORDERKEY)(x => x.L_ORDERKEY)
  ...
  def Q7(numRuns: Int) {
    ...
    runQuery({
      ...
      val gb = new AggOp(jo5, 1)(x => new Q7GRPRecord(
        ...
        dateToYear(x.L_SHIPDATE[Long])))((t, currAgg) => { currAgg + (t.L_EXTENDEDPRICE[Double] * (1.0 - t.L_DISCOUNT[Double])) })
  ...
  def Q8(numRuns: Int) {
    ...
    runQuery({
      ...
      val aggOp = new AggOp(jo7, 3)(x => dateToYear(x.REC2_O_ORDERDATE[Long]))(
  ...
  def Q9(numRuns: Int) {
    ...
    runQuery({
      ...
      val hj2 = new HashJoinOp(soPart, soLineitem)((x, y) => x.P_PARTKEY == y.L_PARTKEY)(x => x.P_PARTKEY)(x => x.L_PARTKEY)
      val hj3 = new HashJoinOp(hj2, soOrders)((x, y) => x.L_ORDERKEY[Int] == y.O_ORDERKEY)(x => x.L_ORDERKEY[Int])(x => x.O_ORDERKEY)
      val hj4 = new HashJoinOp(hj1, hj3)((x, y) => x.S_SUPPKEY[Int] == y.L_SUPPKEY[Int])(x => x.S_SUPPKEY[Int])(x => x.L_SUPPKEY[Int])
      val hj5 = new HashJoinOp(hj4, soPartsupp)((x, y) => y.PS_PARTKEY == x.L_PARTKEY[Int] && y.PS_SUPPKEY == x.L_SUPPKEY[Int])(x => x.L_PARTKEY[Int])(x => x.PS_PARTKEY)
      val aggOp = new AggOp(hj5, 1)(x => new Q9GRPRecord(x.N_NAME[LBString], dateToYear(x.O_ORDERDATE[Long])))(
  ...
  def Q21(numRuns: Int) {
    ...
    runQuery({
      ...
      val jo3 = new HashJoinOp(jo2, ordersScan)((x, y) => y.O_ORDERKEY == x.L_ORDERKEY[Int])(x => x.L_ORDERKEY[Int])(x => x.O_ORDERKEY)
      val jo4 = new HashJoinAnti(jo3, lineitemScan3)((x, y) => (x.L_ORDERKEY[Int] == y.L_ORDERKEY) && (x.L_SUPPKEY[Int] != y.L_SUPPKEY))(x => x.L_ORDERKEY[Int])(x => x.L_ORDERKEY)
      val jo5 = new LeftHashSemiJoinOp(jo4, lineitemScan2)((x, y) => (x.L_ORDERKEY[Int] == y.L_ORDERKEY) && (x.L_SUPPKEY[Int] != y.L_SUPPKEY))(x => x.L_ORDERKEY[Int])(x => x.L_ORDERKEY)
